...
class cam:
    ...
    def cam_detect(self,score,set_num):
        ...
        self.frame_a,self.frame_b,self.video_hit,self.point_a,self.point_b=ts.video_process_one(self.model,self.frame_a,self.frame_b,self.frame_c,self.video_hit,
